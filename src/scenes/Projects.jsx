    ...
    <section id="projects" className="pt-48 pb-48">
      ...
      >
        ...
        <p className="mt-10 mb-10">
          Each project is a different adventure with its own <span className="text-red">UNIQUE</span> story
        </p>
      </motion.div>
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <Project title="Ai-ChatBot" link="https://github.com/oriyomibadmus/AI-Chatbot"/>
